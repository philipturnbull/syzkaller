...
func (p *Prog) RandomizeThreadSchedule(rs rand.Source) {
...
func (p *Prog) MutateThreadSchedule(rs rand.Source) {
	r := newRand(p.Target, rs)
...
func (ctx *mutator) mutateThreadSchedule() bool {
	p, r := ctx.p, ctx.r
